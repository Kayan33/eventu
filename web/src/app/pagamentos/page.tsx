...
import { listPayments, reviewPayment } from "@/lib/api/payments";
            ...
            {payments.map((payment) => (
              ...
              >
                ...
                {payment.pixReceiptUrl ? (
                  <a
                    href={payment.pixReceiptUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-2.5 inline-block text-[13px] font-medium text-accent-700 hover:underline"
                  >
                    Ver comprovante →
                  </a>
                ) : null}
